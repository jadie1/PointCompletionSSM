...
from utils.model_utils import ChamferDistanceL1, ChamferDistanceL1_PM, calc_cd
...
class Model(nn.Module):
    ...
    def get_loss(self, pcds_pred, complete_gt):
        """loss function
        Args
        ...
        cdc = ChamferDistanceL1(Pc, gt_c)
        cd1 = ChamferDistanceL1(P1, gt_1)
        cd2 = ChamferDistanceL1(P2, gt_2)
        cd3 = ChamferDistanceL1(P3, complete_gt)

        partial_matching = ChamferDistanceL1_PM(partial_input, P3)
    ...
    def forward(self, point_cloud, gt, is_training=True, return_P0=False, alpha=None):
        ...
        if is_training:
            ...
            loss1, loss2 = self.get_loss(out, gt)
